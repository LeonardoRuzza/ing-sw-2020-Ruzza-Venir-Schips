...
Execute the phase from 1 to 4 if you have didnt't do it previously or simply run: mvn test -f pom.xml
...
9-Copy or move Santorini.jar (which you have prevoiusly created) in this directory or where you prefer in subdirectory.
