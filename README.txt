...
How to run the Santorini-client.jar with a not default IP address and PORT?
  1- CLI version: java -jar path/Santorini-client.jar cli IP PORT
  2- GUI version: java -jar path/Santorini-client.jar IP PORT
...
How to run the Santorini-server.jar with a not default PORT?
  - CLI version: java -jar path/Santorini-server.jar PORT
